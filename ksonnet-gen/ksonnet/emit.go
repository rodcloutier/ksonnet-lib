...
func (e *emitVisitor) visitRefMixinAPIObject(rmao *refMixinAPIObject) {
	...
	buffer := bytes.Buffer{}
	e.buffers[rmao.prop] = &buffer

	e.m.bufferWriteLine(&buffer, "// TODO ref mixin api object")
}
...
func (e *emitVisitor) visitProperty(p *property) {
	...
	e.m.bufferWriteLine(&buffer, "// TODO property")
}
...
func (root *root) accept(visitor KsonnetVisitor) {
...
func (group *group) accept(visitor KsonnetVisitor, hidden bool) {
	for _, versioned := range group.versionedAPIs.toSortedSlice() {
...
func (va *versionedAPI) accept(visitor KsonnetVisitor) {
	for _, object := range va.apiObjects.toSortedSlice() {
...
func (ao *apiObject) accept(visitor KsonnetVisitor) {
...
func (rmao *refMixinAPIObject) accept(visitor KsonnetVisitor) {
...
func (p *property) accept(visitor KsonnetVisitor) {
	...
	if isMixinRef(p.ref) {
		...
		refMixinApiObject := refMixinAPIObject{
			apiObject: *apiObject,
			prop:      p,
		}
		refMixinApiObject.accept(visitor)
		return
...
func (cs *comments) accept(visitor KsonnetVisitor) {
